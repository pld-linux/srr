...
Niektórzy uważają, że świat un*ksowy powinien się czegoś nauczyć z
QNX-a, a wysoko na tej liście jest mechanizm komunikowania i
synchronizacji poprzez Send/Receive/Reply, będący jedną z
charakterystycznych cech QNX-a. Moduł jądra SRRIPC dla Linuksa pozwala
na pisanie nowego kodu używającego komunikacji S/R/R na maszynie
linuksowej i szybkie portowanie aplikacji między systemem QNX4 a
Linuksem.
...
Moduły jądra Linuksa do IPC w stylu QNX4.
...
Moduły jądra Linuksa SMP do IPC w stylu QNX4.
